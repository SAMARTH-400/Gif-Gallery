        ...
        <div className='h-screen w-full bg-gray-100'>
            <div className='searchcontainer scale-110'>   
                ...
                <div className='searchbox text-black outline-none'> 
                    <input className='h-[30px] w-full bg-transparent ml-10 outline-none' value={input} onChange={ e => setInput(e.target.value) }></input>
                </div>
                <button type="button" className='searchbutton text-lg font-medium hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300' > Search </button>
            </div>
            <div className='gifcontainer scale-110'>
                <Gifs />
